interface TokenResponse {
  ...
  export const exchangeCodeForTokens = async (code: string): Promise<StoredTokens> => {
  ...
  export const parseTokenCookie = (cookieStr: string | undefined): StoredTokens | null => {
  ...
  export const getValidAccessToken = async (tokens: StoredTokens): Promise<StoredTokens> => {
